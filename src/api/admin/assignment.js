...
export const getAssignmentStats = () => {
  return request({
    url: '/api/v1/admin/assignment/stats',
    method: 'get'
  })
}
...
export const getUnassignedStudents = (params) => {
  return request({
    url: '/api/v1/admin/assignment/unassigned-students',
    method: 'get',
    params
  })
}
...
export const getAvailableTeachers = (params) => {
  return request({
    url: '/api/v1/admin/assignment/available-teachers',
    method: 'get',
    params
  })
}
...
export const assignSingleStudent = (data) => {
  return request({
    url: '/api/v1/admin/assignment/single-assign',
    method: 'post',
    data
  })
}
...
export const assignBatchStudents = (data) => {
  return request({
    url: '/api/v1/admin/assignment/batch-assign',
    method: 'post',
    data
  })
}
...
export const getAssignmentRules = () => {
  return request({
    url: '/api/v1/admin/assignment/rules',
    method: 'get'
  })
}
...
export const refreshAssignmentData = () => {
  return request({
    url: '/api/v1/admin/assignment/refresh',
    method: 'post'
  })
}